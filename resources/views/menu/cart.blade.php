...
{{--            </div>--}}
    ...
    <div class="container-fluid" style="margin-top: 30px;">
        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="background-color:hsl(177, 30%, 85%); ">
                <h1 class="h1" style="padding-left: 150px;">Menu</h1>
                <hr>
                    ...
                    @for($i=0; $i<$countCate; $i++)
                        ...
                        <article class="product" style="width: 128px;">
                            ...
                            <h4>
                                ...
                                <button type="button" style="border: none; float:right;" data-toggle="modal" data-target="#{{$value->pro_slug}}">
                                    <i class='fas fa-plus-circle' style="font-size: 16px; color: steelblue;"></i>
                                </button>
                            </h4>
    ...
    {{--            SHOPPING CARTTTTTTTTTTTTTTTT--}}
            <div class="col-sm-5" style="background-color:#e3e8e9;" id="shopping-cart">
